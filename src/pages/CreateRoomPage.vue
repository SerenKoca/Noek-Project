    ...
    <div class="settings-page-v2 create-room-v2 editor-home-shell">
      ...
      <section class="settings-content-v2 two-column">
        ...
        <div class="settings-right-v2 right-column">
          ...
          <button type="button" class="primary-btn wide" style="margin-top:18px">Bekijk bijdrages van de kamer</button>

          <div class="bottom-actions">
            <button type="button" class="text-back" @click="goBack">‹ Back</button>
